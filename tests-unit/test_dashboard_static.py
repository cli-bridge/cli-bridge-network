...
class DashboardStaticTests(unittest.TestCase):
    ...
    def test_cli_anything_commands_are_staged(self):
        ...
        self.assertIn("python -m cbn plugin promotion-gate cli-anything py4csr --from-market --smoke-suite --smoke-extra-arg=--help", self.html)
        self.assertIn("/plugins/cli-anything/promotion-gate", self.html)
        self.assertIn('"run_smoke_suite":true', self.html)
