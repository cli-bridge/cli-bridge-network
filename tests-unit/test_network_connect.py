...
class NetworkConnectPackageTests(unittest.TestCase):
    def test_network_connect_package_collects_external_and_internal_contracts(self):
        ...
        self.assertEqual(payload["summary"]["consumer_sdk_bootstrap_request_count"], 16)
        ...
        self.assertEqual(entry_profile["evidence"]["acceptance_check_count"], 16)
        ...
        self.assertEqual(presenter["decision_gates"]["mvp_readiness_score"], "17/17")
        ...
        self.assertEqual(proof_points["sdk_bootstrap_handoff"]["value"], "16 typed requests")
        ...
        self.assertEqual(launch["success_gates"]["mvp_readiness_score"], "17/17")
        ...
        self.assertEqual(sdk_bootstrap["request_count"], 16)
        ...
        self.assertEqual(payload["acceptance"]["checks"][5]["request_id"], "import_catalog")
        self.assertEqual(payload["acceptance"]["checks"][5]["expect"]["json.kind"], "CliRegistrationSurface")
        self.assertEqual(payload["acceptance"]["checks"][6]["request_id"], "direct_cli_readiness")
        self.assertEqual(payload["acceptance"]["checks"][6]["expect"]["json.kind"], "DirectCliReadinessReport")
        self.assertEqual(payload["acceptance"]["checks"][9]["request_id"], "inspect_agent_nodes")
        self.assertEqual(payload["acceptance"]["checks"][9]["expect"]["json.kind"], "AdapterAgentNodeBundle")
        self.assertEqual(payload["acceptance"]["checks"][10]["request_id"], "export_protocols")
        self.assertEqual(payload["acceptance"]["checks"][10]["expect"]["json.exports.mcp.protocol"], "mcp")
        self.assertEqual(payload["acceptance"]["checks"][11]["request_id"], "plan_agent_request")
        self.assertEqual(
            payload["acceptance"]["checks"][11]["expect"]["json.reusable_harness.kind"],
            "NaturalLanguageWorkflowHarness",
        )
        self.assertEqual(payload["acceptance"]["checks"][13]["request_id"], "events")
        self.assertEqual(payload["acceptance"]["checks"][13]["expect"]["json.count_min"], 1)
        self.assertEqual(payload["acceptance"]["checks"][14]["request_id"], "audit")
        self.assertEqual(payload["acceptance"]["checks"][14]["expect"]["json.count_min"], 1)
        self.assertEqual(payload["acceptance"]["checks"][15]["request_id"], "artifacts")
        ...
        self.assertEqual(quickstart["sequence_steps"][5]["request_id"], "import_catalog")
        self.assertEqual(quickstart["sequence_steps"][6]["request_id"], "direct_cli_readiness")
        self.assertEqual(quickstart["sequence_steps"][12]["request_id"], "run_workflow")
        ...
        self.assertEqual(len(quickstart["requests"]), 16)
    ...
    def test_network_quickstart_cli_outputs_first_call_package(self):
        ...
        self.assertEqual(payload["requests"][5]["id"], "import_catalog")
        self.assertEqual(payload["requests"][6]["id"], "direct_cli_readiness")
        ...
        self.assertEqual(payload["sequence_steps"][6]["request_id"], "direct_cli_readiness")
        self.assertEqual(payload["sequence_steps"][12]["request_id"], "run_workflow")
        self.assertEqual(payload["sequence_steps"][-1]["request_ids"], ["events", "audit", "artifacts"])
        self.assertEqual(payload["requests"][9]["id"], "inspect_agent_nodes")
        self.assertEqual(payload["requests"][10]["id"], "export_protocols")
        self.assertEqual(payload["requests"][12]["id"], "run_workflow")
        self.assertEqual(payload["requests"][12]["headers"]["X-CBN-Session"], "test-token")
        self.assertIn("curl -X POST", payload["requests"][12]["curl"])
        self.assertEqual(payload["acceptance"]["kind"], "NetworkConnectionAcceptance")
        self.assertEqual(payload["acceptance"]["check_count"], 16)
        self.assertEqual(payload["acceptance"]["checks"][1]["request_id"], "launch_contract")
        self.assertEqual(payload["acceptance"]["checks"][2]["request_id"], "entry_profile")
        ...
        self.assertEqual(payload["acceptance"]["checks"][5]["request_id"], "import_catalog")
        self.assertEqual(payload["acceptance"]["checks"][6]["request_id"], "direct_cli_readiness")
        self.assertEqual(payload["acceptance"]["checks"][12]["request_id"], "run_workflow")
    ...
    def test_network_acceptance_cli_outputs_checklist(self):
        ...
        self.assertEqual(payload["check_count"], 16)
    ...
    def test_network_sdk_bootstrap_cli_outputs_stable_sdk_contract(self):
        ...
        self.assertEqual(payload["request_count"], 16)
        self.assertNotIn("test-token", json.dumps(payload, ensure_ascii=False))
        self.assertNotIn("contracts", payload)
    ...
    def test_network_quickstart_cli_outputs_acceptance_checklist(self):
        ...
        self.assertEqual(payload["checks"][5]["request_id"], "import_catalog")
        self.assertEqual(payload["checks"][5]["expect"]["json.kind"], "CliRegistrationSurface")
        self.assertEqual(payload["checks"][6]["request_id"], "direct_cli_readiness")
        self.assertEqual(payload["checks"][6]["expect"]["json.kind"], "DirectCliReadinessReport")
        self.assertEqual(payload["checks"][9]["request_id"], "inspect_agent_nodes")
        self.assertEqual(payload["checks"][9]["expect"]["json.kind"], "AdapterAgentNodeBundle")
        self.assertEqual(payload["checks"][10]["request_id"], "export_protocols")
        self.assertEqual(payload["checks"][10]["expect"]["json.exports.acp.protocol"], "acp")
        self.assertEqual(payload["checks"][11]["expect"]["json.kind"], "AdapterAgentWorkflowRequestPlan")
