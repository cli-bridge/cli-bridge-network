...
class NetworkConnectPackageTests(unittest.TestCase):
    def test_network_connect_package_collects_external_and_internal_contracts(self):
        ...
        self.assertEqual(entry_profile["evidence"]["acceptance_check_count"], 12)
        ...
        self.assertEqual(launch["success_gates"]["acceptance_check_count"], 12)
        ...
        self.assertEqual(payload["acceptance"]["check_count"], 12)
        ...
        self.assertEqual(payload["acceptance"]["checks"][2]["request_id"], "import_catalog")
        self.assertEqual(payload["acceptance"]["checks"][2]["expect"]["json.kind"], "CliRegistrationSurface")
        self.assertEqual(payload["acceptance"]["checks"][5]["request_id"], "inspect_agent_nodes")
        self.assertEqual(payload["acceptance"]["checks"][5]["expect"]["json.kind"], "AdapterAgentNodeBundle")
        self.assertEqual(payload["acceptance"]["checks"][6]["request_id"], "export_protocols")
        self.assertEqual(payload["acceptance"]["checks"][6]["expect"]["json.exports.mcp.protocol"], "mcp")
        self.assertEqual(payload["acceptance"]["checks"][7]["request_id"], "plan_agent_request")
        self.assertEqual(
            payload["acceptance"]["checks"][7]["expect"]["json.reusable_harness.kind"],
            "NaturalLanguageWorkflowHarness",
        )
        self.assertEqual(payload["acceptance"]["checks"][9]["request_id"], "events")
        self.assertEqual(payload["acceptance"]["checks"][9]["expect"]["json.count_min"], 1)
        self.assertEqual(payload["acceptance"]["checks"][10]["request_id"], "audit")
        self.assertEqual(payload["acceptance"]["checks"][10]["expect"]["json.count_min"], 1)
        self.assertEqual(payload["acceptance"]["checks"][11]["request_id"], "artifacts")
        ...
        self.assertEqual(quickstart["sequence_steps"][2]["request_id"], "import_catalog")
        ...
        self.assertEqual(len(quickstart["requests"]), 12)
    ...
    def test_network_quickstart_cli_outputs_first_call_package(self):
        ...
        self.assertEqual(payload["requests"][2]["id"], "import_catalog")
        self.assertEqual(payload["sequence_steps"][1]["request_id"], "launch_contract")
        self.assertEqual(payload["sequence_steps"][8]["request_id"], "run_workflow")
        self.assertEqual(payload["sequence_steps"][-1]["request_ids"], ["events", "audit", "artifacts"])
        self.assertEqual(payload["requests"][5]["id"], "inspect_agent_nodes")
        self.assertEqual(payload["requests"][6]["id"], "export_protocols")
        self.assertEqual(payload["requests"][8]["id"], "run_workflow")
        self.assertEqual(payload["requests"][8]["headers"]["X-CBN-Session"], "test-token")
        self.assertIn("curl -X POST", payload["requests"][8]["curl"])
        self.assertEqual(payload["acceptance"]["kind"], "NetworkConnectionAcceptance")
        self.assertEqual(payload["acceptance"]["check_count"], 12)
        self.assertEqual(payload["acceptance"]["checks"][1]["request_id"], "launch_contract")
        self.assertEqual(payload["acceptance"]["checks"][2]["request_id"], "import_catalog")
        self.assertEqual(payload["acceptance"]["checks"][8]["request_id"], "run_workflow")
    ...
    def test_network_quickstart_cli_outputs_acceptance_checklist(self):
        ...
        self.assertEqual(payload["checks"][2]["request_id"], "import_catalog")
        self.assertEqual(payload["checks"][2]["expect"]["json.kind"], "CliRegistrationSurface")
        self.assertEqual(payload["checks"][5]["request_id"], "inspect_agent_nodes")
        self.assertEqual(payload["checks"][5]["expect"]["json.kind"], "AdapterAgentNodeBundle")
        self.assertEqual(payload["checks"][6]["request_id"], "export_protocols")
        self.assertEqual(payload["checks"][6]["expect"]["json.exports.acp.protocol"], "acp")
        self.assertEqual(payload["checks"][7]["expect"]["json.kind"], "AdapterAgentWorkflowRequestPlan")
