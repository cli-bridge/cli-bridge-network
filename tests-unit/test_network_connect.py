...
class NetworkConnectPackageTests(unittest.TestCase):
    def test_network_connect_package_collects_external_and_internal_contracts(self):
        ...
        self.assertEqual(entry_profile["evidence"]["acceptance_check_count"], 13)
        ...
        self.assertEqual(launch["success_gates"]["acceptance_check_count"], 13)
        ...
        self.assertEqual(payload["acceptance"]["check_count"], 13)
        ...
        self.assertEqual(payload["acceptance"]["checks"][6]["request_id"], "inspect_agent_nodes")
        self.assertEqual(payload["acceptance"]["checks"][6]["expect"]["json.kind"], "AdapterAgentNodeBundle")
        self.assertEqual(payload["acceptance"]["checks"][7]["request_id"], "export_protocols")
        self.assertEqual(payload["acceptance"]["checks"][7]["expect"]["json.exports.mcp.protocol"], "mcp")
        self.assertEqual(payload["acceptance"]["checks"][8]["request_id"], "plan_agent_request")
        self.assertEqual(
            payload["acceptance"]["checks"][8]["expect"]["json.reusable_harness.kind"],
            "NaturalLanguageWorkflowHarness",
        )
        self.assertEqual(payload["acceptance"]["checks"][10]["request_id"], "events")
        self.assertEqual(payload["acceptance"]["checks"][10]["expect"]["json.count_min"], 1)
        self.assertEqual(payload["acceptance"]["checks"][11]["request_id"], "audit")
        self.assertEqual(payload["acceptance"]["checks"][11]["expect"]["json.count_min"], 1)
        self.assertEqual(payload["acceptance"]["checks"][12]["request_id"], "artifacts")
        ...
        self.assertEqual(len(quickstart["requests"]), 13)
    ...
    def test_network_quickstart_cli_outputs_first_call_package(self):
        ...
        self.assertEqual(payload["sequence_steps"][9]["request_id"], "run_workflow")
        self.assertEqual(payload["sequence_steps"][-1]["request_ids"], ["events", "audit", "artifacts"])
        self.assertEqual(payload["requests"][6]["id"], "inspect_agent_nodes")
        self.assertEqual(payload["requests"][7]["id"], "export_protocols")
        self.assertEqual(payload["requests"][9]["id"], "run_workflow")
        self.assertEqual(payload["requests"][9]["headers"]["X-CBN-Session"], "test-token")
        self.assertIn("curl -X POST", payload["requests"][9]["curl"])
        self.assertEqual(payload["acceptance"]["kind"], "NetworkConnectionAcceptance")
        self.assertEqual(payload["acceptance"]["check_count"], 13)
        self.assertEqual(payload["acceptance"]["checks"][1]["request_id"], "launch_contract")
        self.assertEqual(payload["acceptance"]["checks"][2]["request_id"], "entry_profile")
        self.assertEqual(payload["acceptance"]["checks"][3]["request_id"], "import_catalog")
        self.assertEqual(payload["acceptance"]["checks"][9]["request_id"], "run_workflow")
    ...
    def test_network_quickstart_cli_outputs_acceptance_checklist(self):
        ...
        self.assertEqual(payload["checks"][6]["request_id"], "inspect_agent_nodes")
        self.assertEqual(payload["checks"][6]["expect"]["json.kind"], "AdapterAgentNodeBundle")
        self.assertEqual(payload["checks"][7]["request_id"], "export_protocols")
        self.assertEqual(payload["checks"][7]["expect"]["json.exports.acp.protocol"], "acp")
        self.assertEqual(payload["checks"][8]["expect"]["json.kind"], "AdapterAgentWorkflowRequestPlan")
