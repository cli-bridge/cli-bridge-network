...
class NetworkConnectPackageTests(unittest.TestCase):
    def test_network_connect_package_collects_external_and_internal_contracts(self):
        ...
        self.assertEqual(entry_profile["evidence"]["acceptance_check_count"], 14)
        ...
        self.assertEqual(mvp["score"], "13/13")
        self.assertEqual(payload["summary"]["mvp_readiness_status"], "ready")
        self.assertEqual(payload["summary"]["mvp_readiness_score"], "13/13")
        ...
        self.assertEqual(presenter["decision_gates"]["mvp_readiness_score"], "13/13")
        ...
        self.assertEqual(launch["success_gates"]["mvp_readiness_score"], "13/13")
        self.assertEqual(launch["success_gates"]["acceptance_check_count"], 14)
        ...
        self.assertEqual(payload["acceptance"]["check_count"], 14)
        ...
        self.assertEqual(payload["acceptance"]["checks"][3]["request_id"], "import_catalog")
        self.assertEqual(payload["acceptance"]["checks"][3]["expect"]["json.kind"], "CliRegistrationSurface")
        self.assertEqual(payload["acceptance"]["checks"][4]["request_id"], "direct_cli_readiness")
        self.assertEqual(payload["acceptance"]["checks"][4]["expect"]["json.kind"], "DirectCliReadinessReport")
        self.assertEqual(payload["acceptance"]["checks"][7]["request_id"], "inspect_agent_nodes")
        self.assertEqual(payload["acceptance"]["checks"][7]["expect"]["json.kind"], "AdapterAgentNodeBundle")
        self.assertEqual(payload["acceptance"]["checks"][8]["request_id"], "export_protocols")
        self.assertEqual(payload["acceptance"]["checks"][8]["expect"]["json.exports.mcp.protocol"], "mcp")
        self.assertEqual(payload["acceptance"]["checks"][9]["request_id"], "plan_agent_request")
        self.assertEqual(
            payload["acceptance"]["checks"][9]["expect"]["json.reusable_harness.kind"],
            "NaturalLanguageWorkflowHarness",
        )
        self.assertEqual(payload["acceptance"]["checks"][11]["request_id"], "events")
        self.assertEqual(payload["acceptance"]["checks"][11]["expect"]["json.count_min"], 1)
        self.assertEqual(payload["acceptance"]["checks"][12]["request_id"], "audit")
        self.assertEqual(payload["acceptance"]["checks"][12]["expect"]["json.count_min"], 1)
        self.assertEqual(payload["acceptance"]["checks"][13]["request_id"], "artifacts")
        ...
        self.assertEqual(quickstart["sequence_steps"][3]["request_id"], "import_catalog")
        self.assertEqual(quickstart["sequence_steps"][4]["request_id"], "direct_cli_readiness")
        self.assertEqual(quickstart["sequence_steps"][10]["request_id"], "run_workflow")
        ...
        self.assertEqual(len(quickstart["requests"]), 14)
    ...
    def test_network_connect_package_cli_outputs_json(self):
        ...
        self.assertEqual(payload["mvp_readiness"]["score"], "13/13")
    ...
    def test_network_quickstart_cli_outputs_first_call_package(self):
        ...
        self.assertEqual(payload["requests"][3]["id"], "import_catalog")
        self.assertEqual(payload["requests"][4]["id"], "direct_cli_readiness")
        ...
        self.assertEqual(payload["sequence_steps"][4]["request_id"], "direct_cli_readiness")
        self.assertEqual(payload["sequence_steps"][10]["request_id"], "run_workflow")
        self.assertEqual(payload["sequence_steps"][-1]["request_ids"], ["events", "audit", "artifacts"])
        self.assertEqual(payload["requests"][7]["id"], "inspect_agent_nodes")
        self.assertEqual(payload["requests"][8]["id"], "export_protocols")
        self.assertEqual(payload["requests"][10]["id"], "run_workflow")
        self.assertEqual(payload["requests"][10]["headers"]["X-CBN-Session"], "test-token")
        self.assertIn("curl -X POST", payload["requests"][10]["curl"])
        self.assertEqual(payload["acceptance"]["kind"], "NetworkConnectionAcceptance")
        self.assertEqual(payload["acceptance"]["check_count"], 14)
        self.assertEqual(payload["acceptance"]["checks"][1]["request_id"], "launch_contract")
        self.assertEqual(payload["acceptance"]["checks"][2]["request_id"], "entry_profile")
        self.assertEqual(payload["acceptance"]["checks"][3]["request_id"], "import_catalog")
        self.assertEqual(payload["acceptance"]["checks"][4]["request_id"], "direct_cli_readiness")
        self.assertEqual(payload["acceptance"]["checks"][10]["request_id"], "run_workflow")
    ...
    def test_network_acceptance_cli_outputs_checklist(self):
        ...
        self.assertEqual(payload["check_count"], 14)
    ...
    def test_network_quickstart_cli_outputs_acceptance_checklist(self):
        ...
        self.assertEqual(payload["checks"][2]["expect"]["json.kind"], "NetworkEntryProfile")
        self.assertEqual(payload["checks"][2]["expect"]["json.auth.secret_values_echoed"], False)
        self.assertEqual(payload["checks"][3]["request_id"], "import_catalog")
        self.assertEqual(payload["checks"][3]["expect"]["json.kind"], "CliRegistrationSurface")
        self.assertEqual(payload["checks"][4]["request_id"], "direct_cli_readiness")
        self.assertEqual(payload["checks"][4]["expect"]["json.kind"], "DirectCliReadinessReport")
        self.assertEqual(payload["checks"][7]["request_id"], "inspect_agent_nodes")
        self.assertEqual(payload["checks"][7]["expect"]["json.kind"], "AdapterAgentNodeBundle")
        self.assertEqual(payload["checks"][8]["request_id"], "export_protocols")
        self.assertEqual(payload["checks"][8]["expect"]["json.exports.acp.protocol"], "acp")
        self.assertEqual(payload["checks"][9]["expect"]["json.kind"], "AdapterAgentWorkflowRequestPlan")
    ...
    def test_network_quickstart_cli_outputs_mvp_readiness(self):
        ...
        self.assertEqual(payload["status"], "ready")
        self.assertEqual(payload["score"], "13/13")
