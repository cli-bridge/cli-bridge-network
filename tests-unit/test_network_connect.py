...
class NetworkConnectPackageTests(unittest.TestCase):
    def test_network_connect_package_collects_external_and_internal_contracts(self):
        ...
        self.assertEqual(presenter["decision_gates"]["mvp_readiness_score"], "14/14")
        ...
        self.assertEqual(launch["success_gates"]["mvp_readiness_score"], "14/14")
        self.assertEqual(launch["success_gates"]["acceptance_check_count"], 15)
        ...
        self.assertEqual(payload["acceptance"]["checks"][4]["expect"]["json.kind"], "CliRegistrationSurface")
        ...
        self.assertEqual(payload["acceptance"]["checks"][8]["expect"]["json.kind"], "AdapterAgentNodeBundle")
        self.assertEqual(payload["acceptance"]["checks"][9]["request_id"], "export_protocols")
        self.assertEqual(payload["acceptance"]["checks"][9]["expect"]["json.exports.mcp.protocol"], "mcp")
        self.assertEqual(payload["acceptance"]["checks"][10]["request_id"], "plan_agent_request")
        self.assertEqual(
            payload["acceptance"]["checks"][10]["expect"]["json.reusable_harness.kind"],
            "NaturalLanguageWorkflowHarness",
        )
        self.assertEqual(payload["acceptance"]["checks"][12]["request_id"], "events")
        self.assertEqual(payload["acceptance"]["checks"][12]["expect"]["json.count_min"], 1)
        self.assertEqual(payload["acceptance"]["checks"][13]["request_id"], "audit")
        self.assertEqual(payload["acceptance"]["checks"][13]["expect"]["json.count_min"], 1)
        self.assertEqual(payload["acceptance"]["checks"][14]["request_id"], "artifacts")
        ...
        self.assertEqual(quickstart["sequence_steps"][4]["request_id"], "import_catalog")
        self.assertEqual(quickstart["sequence_steps"][5]["request_id"], "direct_cli_readiness")
        self.assertEqual(quickstart["sequence_steps"][11]["request_id"], "run_workflow")
        ...
        self.assertEqual(len(quickstart["requests"]), 15)
    ...
    def test_network_quickstart_cli_outputs_first_call_package(self):
        ...
        self.assertEqual(payload["requests"][11]["headers"]["X-CBN-Session"], "test-token")
        self.assertIn("curl -X POST", payload["requests"][11]["curl"])
        self.assertEqual(payload["acceptance"]["kind"], "NetworkConnectionAcceptance")
        self.assertEqual(payload["acceptance"]["check_count"], 15)
        self.assertEqual(payload["acceptance"]["checks"][1]["request_id"], "launch_contract")
        self.assertEqual(payload["acceptance"]["checks"][2]["request_id"], "entry_profile")
    ...
    def test_network_quickstart_cli_outputs_acceptance_checklist(self):
        ...
        self.assertEqual(payload["checks"][4]["request_id"], "import_catalog")
        self.assertEqual(payload["checks"][4]["expect"]["json.kind"], "CliRegistrationSurface")
        self.assertEqual(payload["checks"][5]["request_id"], "direct_cli_readiness")
        self.assertEqual(payload["checks"][5]["expect"]["json.kind"], "DirectCliReadinessReport")
        self.assertEqual(payload["checks"][8]["request_id"], "inspect_agent_nodes")
        self.assertEqual(payload["checks"][8]["expect"]["json.kind"], "AdapterAgentNodeBundle")
        self.assertEqual(payload["checks"][9]["request_id"], "export_protocols")
        self.assertEqual(payload["checks"][9]["expect"]["json.exports.acp.protocol"], "acp")
        self.assertEqual(payload["checks"][10]["expect"]["json.kind"], "AdapterAgentWorkflowRequestPlan")
